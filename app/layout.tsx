...
// The desktop-only gate is NOT here. It wraps individual routes via <DesktopOnly>, because
// /set-password has to work on a phone: invite and reset emails both land there, and they
// are opened wherever the mail was read. See components/layout/DesktopOnly.tsx.
