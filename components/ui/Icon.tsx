...
const PATHS: Record<string, ReactNode> = {
  logo: (
    <>
      ...
      <path d="M7.2 6h9.6M5 8.2V15a1.5 1.5 0 0 0 1.5 1.5h3.3M19 8.2V15a1.5 1.5 0 0 1-1.5 1.5h-3.3" />
    </>
  ),
  ...
  eyeOff: (
    <>
      <path d="M10.6 6.2A9.9 9.9 0 0 1 12 6c6.4 0 10 6 10 6a18 18 0 0 1-3 3.6M6.5 7.6A18 18 0 0 0 2 12s3.6 6 10 6a9.7 9.7 0 0 0 4-.8" />
